  ...
  return (
    <div className="mb-8">
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-2 mb-4 items-start sm:items-center">
        ...
        <div>
          <h3 className="text-lg font-medium text-blue-500">Opt-out</h3>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 sm:p-6 w-full lg:flex-1">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4 sm:mb-2">
            <div>
              <h4 className="font-medium">Opt-out Response</h4>
            ...
            <Switch 
              ...
              className="self-start sm:self-center data-[state=checked]:bg-blue-500"
            />
          </div>
        ...
        <div className="w-full lg:flex-1">
          <div className="flex flex-col sm:flex-row sm:justify-between gap-2 mb-4 sm:mb-2">
            <div>
              <h4 className="font-medium">Opt-out Keywords</h4>
              <p className="text-sm text-gray-500 max-w-[90%] sm:max-w-full">
